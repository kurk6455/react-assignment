...
import { filteredWishListState, selectedTypeState, wishListBtnState } from "../utilities/recoil_state";
import { WishItem } from "./WishItem";

export const WishList = () => {
    console.log("Rendering <WishList>");

    const wishListBtn = useRecoilValue(wishListBtnState);
    const setSelectedType = useSetRecoilState(selectedTypeState);
    const filteredWishlist = useRecoilValue(filteredWishListState);
